...
app = Flask(__name__)
app.secret_key="abc"
app.config['UPLOAD_FOLDER'] = "Testing Images"
# Authenticate using an IAM API key
client = Cloudant.iam('f9f5e849-68df-4795-bf18-687937264b9a-bluemix','TbxDhChV8Cdt_vRuRODWLO8c3KYGM6Zx6cCkAKvyoF4g',connect=True)
...
def predict():
    if request.method == "POST":
        ...
        filepath = os.path.join(str(basepath), 'Testing Images', str(f.filename))
